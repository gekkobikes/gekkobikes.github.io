  ...
  activateCarousels: function () {
    ...
    if (itemsCount && carousel.arrowButtons) {
      ...
      for (i = 0; i < itemsCount; i++) {
        dotsList.innerHTML += '<li><input type="radio" name="carousel" class="carousel-dot carousel-nav" data-value="' + i + '" id="i' + i + '"' + (i === 0 ? ' checked' : '') + '><label for="i' + i + '"><span class="visuallyhidden">' + (i+1) + ' av ' + itemsCount + '</span></label></li>'
      }
